        ...
        :host {
          ...
          --app-grid-item-height: 100%;
			...
			<div class="banner flexchild flex-vertical">
				<iron-image class="bg" preload fade sizing="contain" src="../images/assets/collections/others.svg"  alt="Banner"></iron-image>
			</div>
			...
			<template is="dom-repeat" items="[[ajaxResponse0.others]]" as="others">
				...
				<div class$="[[getUIType(UI)]] actions flex-center-center">
					<a href="{{others.link}}">
						<paper-button class$="[[_computeBgClass(others.color)]]" aria-label="View all">View all collections<iron-icon icon="my-icons:chevron-right"></iron-icon></paper-button>
					</a>
				</div>
			</template>
			<template is="dom-repeat" items="[[ajaxResponse0.similar]]" as="similar">
				...
				<div class$="[[getUIType(UI)]] actions flex-center-center">
					<a href="{{similar.link}}">
						<paper-button class$="[[_computeBgClass(similar.color)]]" aria-label="View all">View all {{similar.title}} collections<iron-icon icon="my-icons:chevron-right"></iron-icon></paper-button>
					</a>
				</div>
			</template>
    `;
