...
class MyApp extends PolymerElement {
    ...
    return html`
      <style include="shared-styles">
        :host {
          ...
          --divider-text-color: rgba(0, 0, 0, 0.38);
          --light-text-color: rgba(0, 0, 0, 0.12);
        ...
        #home.iron-selected,
        #collections.iron-selected,
        #discover.iron-selected,
        #activity.iron-selected {
          color: #fff;
        }
        app-header {
      ...
      <app-header-layout>
        ...
        >
          <app-toolbar>
            ...
            ></paper-icon-button>
            <div condensed-title class="leftItem" hidden$="{{wideLayout}}">
              {{page}}
            </div>
            <div main-title class="rightItem">Lean VR</div>
            <a href="404"
              ><paper-icon-button
  ...
  _routePageChanged(page) {
    ...
    if (!page) {
      ...
      ["home", "collections", "discover", "activity", "new", "view4"].indexOf(
        page
      ) !== -1
    ) {
      this.page = page;
    ...
    // Change page title
    document.title =
      this.page.charAt(0).toUpperCase() + this.page.slice(1) + " - Lean VR";
