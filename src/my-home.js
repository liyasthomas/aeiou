...
class MyHome extends PolymerElement {
  static get template() {
    return html`
      ...
      <template
        is="dom-repeat"
        items="[[ajaxResponse0.collections]]"
        as="collections"
      >
        <div class$="[[getUIType(UI)]] actions flex-justified">
          <div class="title">{{collections.title}}</div>
        </div>
            ...
            <template is="dom-repeat" items="[[collections.sub]]" as="sub">
              <div class="item">
                <div class="container" style="text-align: center;">
                  ...
                  <div
                    class="flexchild flex-vertical"
                    style="padding: 32px; border-left: 1px solid var(--light-text-color); border-right: 1px solid var(--light-text-color);"
                  >
                    <iron-image
                      class="bg"
                      preload
        ...
        <div class$="[[getUIType(UI)]] actions flex-center-center">
          <a href="{{collections.link}}">
            <paper-button class="primary" aria-label="View all"
              >View all collections</paper-button
            >
          </a>
        </div>
      </template>
      ...
      >
        <div class$="[[getUIType(UI)]] actions flex-justified">
          ...
          <div>
            ...
            <paper-icon-button toggles active="{{rotate}}" icon="my-icons:360">
            </paper-icon-button>
            <paper-icon-button
              hidden$="{{!wideLayout}}"
              toggles
              ...
              <div class="item" name="{{sub.model}}">
                <div class="container">
                  ...
                  <div class="flexchild flex-vertical">
                    <model-viewer
                      src="https://raw.githubusercontent.com/liyasthomas/lvr/master/assets/gltf/{{sub.model}}/scene.gltf"
                      alt="{{sub.title}}"
