    ...
    return html`
      ...
      <iron-pages selected="{{selected}}" attr-for-selected="name">
        <div name="collections">
          <iron-ajax
            auto
            url="../data/collections_feeds.json"
            id="ajax0"
            loading="{{loading0}}"
            handle-as="json"
            last-error="{{error0}}"
          ...
          >
            ...
            <template is="dom-if" if="{{!renderedCount}}">
              <div class$="[[getUIType(UI)]] content flex-justified">
                ...
                <a class="link" href="404">Try harder</a>
              </div>
            </template>
            ...
            <div class$="[[getUIType(UI)]] content flex-center-center">
              ...
              <a href="{{collections.link}}">
                <paper-button aria-label="View all"
                  >Suggest a new collection</paper-button
                >
              </a>
            </div>
          </template>
        ...
        <div name="my">
          ...
          >
            ...
            <div class$="[[getUIType(UI)]] content flex-center-center">
              ...
              <a href="{{collections.link}}">
                <paper-button aria-label="View all"
                  >Create a new collection</paper-button
                >
              </a>
            </div>
          </template>
